...
elif torch.__version__.startswith("1.11"):
...
class ZeroRedundancyOptimizer(Optimizer, Joinable):
    ...
    def __init__(
        ...
        **defaults: Any,
        ...
        # GCU not support parameters_as_bucket_view and overlap_with_ddp
    ...
    def step(
        ...
        **kwargs: Any,
        ...
        # move to C++ imp for GCU, because at this time, the parameters have not been updated
        # self._sync_params()
    ...
    def _verify_and_init_params(
        ...
        if isinstance(params, torch.Tensor):
            raise TypeError("`params` argument should be an iterable of "
                            f"Tensors, but got {params.dtype}")
        try:
    ...
    def _verify_same_dense_param_type(self) -> None:
        ...
        typename =self._all_params[0].dtype
